...
public class ProgramConverter implements MiniJavaListener {
    ...
    public void enterIfElseStatement(MiniJavaParser.IfElseStatementContext ctx) {
        tabPrint(indent_level);
        String str = "if " + ctx.LP() + " " + getExpression(ctx.expression()) + " " + ctx.RP() + " " ;
        System.out.print(str);
        indent_level += 1;
    }
...
//        System.out.println("}");
    ...
    public void enterWhileStatement(MiniJavaParser.WhileStatementContext ctx) {
        tabPrint(indent_level);
        String str = "while " + ctx.LP() + " " + getExpression(ctx.expression()) + " " + ctx.RP() ;
